            ...
            <table id="albumsTable" class="min-w-full bg-white">
                <thead>
                    <tr class="w-full bg-gray-500 text-white">
                        ...
                        <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 tracking-wider">Foto</th>
                        <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 tracking-wider">Name Foto</th>
                        <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 tracking-wider">Status Foto</th>
                    ...
                    @foreach ($statuss as $photo)
                        <tr class="{{ $loop->even ? 'bg-gray-50' : 'bg-white' }}">
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200"><img
                                    src="{{ '../storage/' . $photo->lokasifoto }}" class="w-20" alt="">
                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $photo->nama_foto }}</td>
