        ...
        <form class="max-w mx-auto grid grid-cols-2 gap-4" action="{{ route('foto.form.post') }}" method="POST"
                ...
                <div class="max-w mx-auto bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="px-4 py-6">
                        <div id="preview-container"
                            ...
                            <input id="upload-btn" type="file" name="lokasifoto" class="hidden" accept="image/*" />
            ...
            <div class="col-span-2">
                ...
                <textarea id="deskripsi"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    placeholder="Deskripsi Foto" name="deskripsi_foto"></textarea>
                <img id="preview" class="mt-2 rounded-lg object-cover" style="max-width: 150px; max-height: 150px" />
            </div>
